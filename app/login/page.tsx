...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 px-4">
      ...
      <div className="flex w-full max-w-4xl flex-col items-center justify-center gap-6 lg:flex-row lg:gap-4">
        <div className="hidden h-[380px] w-[380px] shrink-0 lg:block">
          <iframe
            src="https://app.spline.design/file/ce9ed780-c0a5-4864-a48f-ba872c77f84a?view=preview"
            className="h-full w-full"
            title="Interactive robot mascot that follows your cursor"
